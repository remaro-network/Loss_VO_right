...
class DeepVOTrainer(object):
	...
	def set_model(self,config):
		model = DeepVOModel(batchNorm=config.model.args.batchNorm,training=config.model.args.training,checkpoint_location=config.model.args.checkpoint_location, output_shape = config.model.args.output_shape,
